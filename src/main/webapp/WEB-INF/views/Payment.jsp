    ...
    <div class='order-info'>
      <div class='order-info-content'>
        ...
        <table class='order-table'>
          <tbody>
            <tr>
              <td><img src=<%= product.getProductPicPath()%> class='full-width'></img>
              </td>
              <td>
                <br> <span class='thin'><%= product.getCategory() %></span>
                <br><%= product.getProductName()%><br> <span class='thin small'> Qty: <%= product.getQty()%><br><br></span>
              </td>	
        ...
        <div class='total'>
          ...
          <span style='float:right; text-align:right;'>
            <div class='thin dense'><%= price%></div>
              <div class='thin dense'><%= price*0.05%></div>
            <div class='thin dense'>50.0</div>
           <%=(price - (price*0.05))+50%>
          </span>
        </div>
</div>
        ...
        <div class='credit-info'>
          <div class='credit-info-content'>
            ...
            Pay Amount
            <input class='input-field' disabled="disabled" value="<%=(price - (price*0.05))+50%>"></input>
            Card Holder
            <input class='input-field'></input>
            <table class='half-input-table'>
              <tr>
          ...
          <a href="usercart" class="back-link"><i class="bi bi-x-circle"></i></a>          
        </div>
      </div>
</div>
</body>
